...
#define MAVLINK_STANDARD_XML_HASH -7204683301257230093
...
#define MAVLINK_MESSAGE_CRCS {{199, 50, 9, 9, 0, 0, 0}, {300, 217, 22, 22, 0, 0, 0}}
#endif
...
# define MAVLINK_MESSAGE_NAMES {{ "HEARTBEAT", 199 }, { "PROTOCOL_VERSION", 300 }}
